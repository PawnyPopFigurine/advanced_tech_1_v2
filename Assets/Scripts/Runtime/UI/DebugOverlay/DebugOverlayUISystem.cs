...
namespace JZK.UI
{
    public class DebugOverlayUISystem : GameSystem<DebugOverlayUISystem>, IUISystem
    {
        #region IUISystem
        ...
        private DebugOverlayUIController _controller;
        bool _active = false;
        ...
        void LoadUIPrefab()
        {
            Addressables.LoadAssetAsync<GameObject>("Assets/Prefabs/UI/DebugOverlay/DebugOverlayUI.prefab").Completed += LoadCompleted;
        }
        ...
        void LoadCompleted(AsyncOperationHandle<GameObject> op)
        {
            ...
            _controller = uiRoot.GetComponent<DebugOverlayUIController>();
