...
namespace JZK.Input
{
    ...
    public class InputSystem : GameSystem<InputSystem>
    {
        ...
        public override void UpdateSystem()
        {
            ...
            UIConfirm = inputAction_UIConfirm.triggered;
            ...
            UICancel = inputAction_UICancel.triggered;
        ...
        private InputAction inputAction_UIConfirm;
        private InputAction inputAction_UICancel;
        ...
        private void SetUpActions()
        {
            ...
            inputAction_UICancel = _playerInput.actions["UI/UICancel"];
            inputAction_UIConfirm = _playerInput.actions["UI/UIConfirm"];
        }
